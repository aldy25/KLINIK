...
<div class="modal fade" id="modaledit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <?= form_open_multipart('Back/Jabatan/updatedata', ['class' => 'formedit']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                ...
                <div style="display: none;" class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input value="<?= $id_jabatan ?>" style="color:black;" type="text" name="id" id="id"
                            class="form-control">
                ...
                <div class="form-group row">
                    <label style=" color:black;" for="nama_jabatan" class="col-sm-2 col-form-label">Nama Jabatan
                    </label>
                    <div class="col-sm-8">
                        <input value="<?= $nama_jabatan ?>" style=" color:black;" type="text" name="nama_jabatan"
                            id="nama_jabatan" class="form-control">
                        <div class="invalid-feedback errornama_jabatan">
                        </div>
                    </div>
                </div>
                ...
                success: function(response) {
                    if (response.error) {
                        if (response.error.nama_jabatan) {
                            ...
                            $('.errornama_jabatan').html(response.error.nama_jabatan);
                        } else {
                            $('#nama_jabatan').removeClass('is-invalid');
                            $('.errornama_jabatan').html('');
                        }
